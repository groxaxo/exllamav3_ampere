#!/usr/bin/env bash
# Quantize Hcompany/Holo3-35B-A3B to EXL3 6.0 bpw
set -euo pipefail
...
HF_REPO="Hcompany/Holo3-35B-A3B"
LOCAL_SRC="/home/op/models/Holo3-35B-A3B"
WORK_DIR="${EXL3_DIR}/models/work_holo3_6bpw"
OUT_DIR="${EXL3_DIR}/models/Holo3-35B-A3B-exl3-6bpw"
LOG="${EXL3_DIR}/logs/quantize_holo3_35b_6bpw.log"
