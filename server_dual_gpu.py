...
app = FastAPI(title="ExLlamaV3 OpenAI Server - Dual GPU")
...
async def load_model():
    ...
    print("Loading model on GPU 0 and GPU 1 (Dual GPU mode)...")
    ...
    model.load(use_per_device=[11.0, 11.0], progressbar=True)
