...
MODEL_DIR = "/home/op/quantized-models/llmfan46-qwen35-27b-heretic-v1/freed0m-exl3-b6"
GPU_ID = 0
PORT = 1234

app = FastAPI(title="ExLlamaV3 OpenAI Server - 3090")
...
def test_max_context():
    ...
    test_sizes = [16384, 32768, 49152, 65536, 81920, 98304, 114688, 131072]
...
async def load_model():
    ...
    cache = Cache(model, max_num_tokens=65536, layer_type=CacheLayer_fp16)

    model.load(use_per_device=[22.0], progressbar=True)
